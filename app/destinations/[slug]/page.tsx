    ...
    <main className="min-h-screen bg-pearl">
      ...
      <section className="py-24 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          <Link href="/#destinations" className="inline-flex items-center text-ink/70 hover:text-gold transition-colors mb-12 group font-medium">
          ...
          <div className="grid md:grid-cols-3 gap-16">
            ...
            <div className="md:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-semibold text-ink mb-6">Discover {destination.title}</h2>
              ...
              <div className="bg-ivory p-8 rounded-2xl border border-ink/5 shadow-soft">
                <h3 className="text-2xl font-semibold text-ink mb-6 flex items-center">
                  <Compass className="w-6 h-6 mr-3 text-champagne" />
            ...
            <div className="space-y-8">
              <div className="bg-twilight-deep text-moonlight p-8 rounded-2xl shadow-xl">
                <h3 className="text-xl font-semibold mb-6">Charter a Yacht Here</h3>
                <Button 
              ...
              <div className="bg-white p-8 rounded-2xl border border-ink/5 shadow-soft">
                <h3 className="text-xl font-semibold text-ink mb-6 border-b border-ink/10 pb-4 flex items-center">
                  <Sun className="w-5 h-5 mr-3 text-champagne" />
                  Best Time to Visit
                </h3>
