...
export function FeaturedIn() {
  return (
    <section className="py-16 px-6 lg:px-12 bg-cream border-y border-border">
        ...
        <div className="overflow-x-auto scrollbar-hide md:overflow-visible">
          <div className="flex gap-12 md:gap-0 md:justify-between items-center min-w-max md:min-w-0 px-4 md:px-0">
            {publications.map((publication, index) => (
              ...
              >
                <span className="text-charcoal/40 hover:text-charcoal/70 transition-colors duration-300 text-lg md:text-xl font-medium tracking-wide">
                  {publication}
                </span>
              </ScrollAnimation>
            ))}
